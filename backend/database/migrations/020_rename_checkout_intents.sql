-- Migration 020: Renombrar transacciones_pendientes a checkout_intents
-- Date: 2025-01-22
-- Purpose: Mejor nomenclatura para intenciones de checkout

USE TiendaMovil;

-- Renombrar tabla si existe
RENAME TABLE IF EXISTS transacciones_pendientes TO checkout_intents;

-- Si la tabla no existe, crearla con el nuevo nombre
